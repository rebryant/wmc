...
useful precision guarantees.  Other tools, such as
FloVer~\cite{becker:fmcad:2016}, can certify the
accuracy of floating-point computations via interval arithmetic, but
we are unaware of their use of for weighted model counting.
...
Although our experiments only use D4, similar results should hold for other top-down and bottom-up weighted model counters.
