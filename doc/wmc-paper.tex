...
also have direct translations into d-DNNF formulas~\cite{oztok:cp:2014}.
We describe how to
...
The weight associated with variable $y$ such that $y \not = x$ are
$w(y) = \langle p(y), 0\rangle$ and
$w(\obar{y}) = \langle 1-p(y), 0\rangle$.
Addition is defined as $\langle p_1, d_1\rangle + \langle p_2, d_2\rangle = \langle p_1 + p_2, d_1 + d_2\rangle$,
