...
performed in weighted model counting.  The special properties of
...
via interval arithmetic~\cite{becker:fmcad:2016}, but we have not seen
experimental results regarding the use of either interval or rational arithmetic for
