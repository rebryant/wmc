...
\begin{tikzpicture}%[scale = 0.70]
  \begin{axis}[mark options={scale=1.0},height=10cm,width=10cm,grid=both, grid style={black!10},
      ...
      legend cell align={left},
                              xmode=log,xmin=0.001, xmax=3000.0,
                              xtick={1e-3, 1e-2, 1e-1, 1, 10, 1e2, 1e3},
                              xticklabels={$0.001$, $0.01$, $0.1$, $1.0$, $10.0$, $100.0$, $1{,}000.0$},
                              ymode=log, ymin=0.001, ymax=3000.0,
                              ytick={1e-3, 1e-2, 1e-1, 1, 10, 1e2, 1e3},
                              yticklabels={$0.001$, $0.01$, $0.1$, $1.0$, $10.0$, $100.0$, $1{,}000.0$},
