...
As can be expected, all data points stay above the precision bound.
...
trend.  Indeed, we should use $c = \log_{10} 3$ for these formulas,
since the weighted model count is of the form $w^n$.
