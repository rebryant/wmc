...
\begin{abstract}
 Weighted model counting computes the sum of the rational-valued weights
  ...
  applications across a variety of domains including machine learning
  ...
  This paper describes how to combine multiple evaluation methods to compute weighted model counts with  high and guaranteed precision.
  When all weights are nonnegative, we prove that the precision loss of
  algebraic evaluation using floating-point arithmetic can be tightly bounded.
  Software-based floating point suffices
...
This paper describes how to combine two strategies to compute 
