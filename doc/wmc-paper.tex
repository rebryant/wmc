...
$p=128$. On most 64-bit architectures, it represents
  the exponent as a 64-bit signed number.  This provides an ample exponent range, giving a magnitude range of over $10^{\pm 10^{18}}$.
\end{itemize}
...
total of $70.91$ hours, for an average time of $104.2$ seconds per
...
time to $45.4$ hours and the average time per instance to $66.2$ seconds.
...
but 4 instances and drop the total time to $20.62$ hours and the
average time per instance to $29.7$ seconds.  Although this approach yields
...
small, but being able to complete all instances is a significant
achievement.
