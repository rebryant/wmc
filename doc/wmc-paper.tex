...
\item For instances with negative weights, perform a sequence of evaluations having successively greater cost:
\begin{enumerate}
\item 
...
\centering{%
\begin{tikzpicture}%[scale = 0.70]
  \begin{axis}[mark options={scale=1.0},height=14.5cm,width=15.2cm,grid=both, grid style={black!10},
