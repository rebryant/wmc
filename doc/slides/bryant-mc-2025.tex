...
\begin{tikzpicture}[scale=0.035]
  ...
  \node [left] at (10,55) {Input};
  \node [left] at (10,40) {Formula};

  \node at (110,60) {decision-DNNF};
  \node at (110,45) {formula};

  \node [right] at (210,55) {Weighted};
  \node [right] at (210,40) {Count};


  \node[white] at (50,30) {Knowledge};
  \node[white] at (50,20) {Compiler};

  \node[white] at (170,30) {Weighted};
  \node[white] at (170,20) {Counter};
