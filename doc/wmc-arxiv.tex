...
\titlerunning{Numerical Considerations in Weighted Model Counting}
...
\begin{tikzpicture}%[scale = 0.70]
  \begin{axis}[mark options={scale=1.0},height=10cm,width=10cm,grid=both, grid style={black!10},
      ...
      legend cell align={left},
                              ...
                              ymode=normal, ymin=0, ymax=49,
                              ytick={0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 47},
                              yticklabels={0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 35.0, 40.0, 45.0, $> 45$, 50.0},
    ...
    \addplot[mark=none, dashed] coordinates{(0,47) (45,47)};
...
\legend{\strut MPFI-64, \strut MPFI-128, \strut MPFI-256, \strut MPQ}
  \end{axis}
\end{tikzpicture}
...
strategy (Y~axis) with target precision $D=30$, versus that for performing an evaluation using rational
...
$1.1$ and $1.5$ times slower, with an average and a median of $1.1$.
