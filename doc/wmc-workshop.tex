...
\begin{abstract}
 Weighted model counting computes the sum of the rational-valued weights
  ...
  achieve the twin goals of efficiency and guaranteed precision.  For
  our evaluations, we have devised especially challenging
  formulas and weight assignments, in order to maximize the robustness
  of our result.
...
devise formulas and weight assignments that present challenging cases
...
be small.  By devising formulas and weight assignments that are
especially challenging from a numerical perspective, we can be confident
